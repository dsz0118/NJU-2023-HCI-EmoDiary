...
public class ChartHistogramView extends View {
    ...
    public ChartHistogramView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mBgColor = typedArray.getColor(R.styleable.ChartLineView_cl_background, getResources().getColor(R.color.grey_2));
        mAxesColor = typedArray.getColor(R.styleable.ChartLineView_cl_axesColor, Color.parseColor("#CCCCCC"));
        mAxesWidth = typedArray.getDimension(R.styleable.ChartLineView_cl_axesWidth, 4);
        ...
        mTextColor = typedArray.getColor(R.styleable.ChartLineView_cl_textColor, Color.parseColor("#FF000000"));
        ...
        maxValue = typedArray.getInteger(R.styleable.ChartLineView_cl_max, 20);
